...
void main() {
    // gl_Position: built-in output variable
...
def main():
    ...
    while not glfwWindowShouldClose(window):
        ...
        red = (glm.sin(now_time*4)+1) *.5
        green = (glm.sin(now_time*2) +1) * .5
        blue = (glm.sin(now_time) + 1) * .5
        glUniform3f(u_color_loc, red, green, blue)
