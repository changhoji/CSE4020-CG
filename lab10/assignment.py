...
def main():
    ...
    right_hand = Node(right_arm, glm.translate(glm.vec3(.5,0,0)), glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    left_arm = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    left_hand = Node(left_arm, glm.translate(glm.vec3(-.5,0,0)), glm.translate((-.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        right_hand.set_joint_transform(glm.rotate(t, (0,0,1)))
        left_arm.set_joint_transform(glm.rotate(-t, (0,0,1)))
        left_hand.set_joint_transform(glm.rotate(-t, (0,0,1)))
        ...
        draw_node(vao_box, right_arm, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, right_hand, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, left_arm, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, left_hand, P*V, MVP_loc_box, color_loc_box)
