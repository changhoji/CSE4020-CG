...
def main():
    ...
    arm = Node(base, glm.translate((.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    arm2 = Node(arm, glm.translate((.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        arm2.set_transform(glm.translate((.5,0,0)) * glm.rotate(t, (0,0,1)))
